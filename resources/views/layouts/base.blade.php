				...
				<div class="menu">
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/accordion.html" data-menu-path="/elements/base/accordion.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Accordion</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/alert.html" data-menu-path="/elements/base/alert.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Alert</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/badge.html" data-menu-path="/elements/base/badge.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Badge</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/breadcrumb.html" data-menu-path="/elements/base/breadcrumb.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Breadcrumb</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/button.html" data-menu-path="/elements/base/button.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Button</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/button-group.html" data-menu-path="/elements/base/button-group.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Button group</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/card.html" data-menu-path="/elements/base/card.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Card</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/color.html" data-menu-path="/elements/base/color.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Color</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/dropdown.html" data-menu-path="/elements/base/dropdown.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Dropdown</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/list-group.html" data-menu-path="/elements/base/list-group.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">List group</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/marker.html" data-menu-path="/elements/base/marker.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Marker</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/modal.html" data-menu-path="/elements/base/modal.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Modal</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/nav.html" data-menu-path="/elements/base/nav.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Navigation</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/offcanvas.html" data-menu-path="/elements/base/offcanvas.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Offcanvas</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/pagination.html" data-menu-path="/elements/base/pagination.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Pagination</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/placeholder.html" data-menu-path="/elements/base/placeholder.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Placeholder</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/popover.html" data-menu-path="/elements/base/popover.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Popover</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/progress.html" data-menu-path="/elements/base/progress.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Progress</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/spinner.html" data-menu-path="/elements/base/spinner.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Spinner</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/tab.html" data-menu-path="/elements/base/tab.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Tab</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/table.html" data-menu-path="/elements/base/table.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Table</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/tooltip.html" data-menu-path="/elements/base/tooltip.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Tooltip</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/base/type.html" data-menu-path="/elements/base/type.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/avatar.html" data-menu-path="/elements/advanced/avatar.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Avatar</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/block-ui.html" data-menu-path="/elements/advanced/block-ui.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Block UI</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/carousel.html" data-menu-path="/elements/advanced/carousel.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Carousel</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/chat.html" data-menu-path="/elements/advanced/chat.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Chat</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/context-menu.html" data-menu-path="/elements/advanced/context-menu.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Context menu</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/grid-nav.html" data-menu-path="/elements/advanced/grid-nav.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Grid nav</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/rich-list.html" data-menu-path="/elements/advanced/rich-list.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Rich list</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/sortable.html" data-menu-path="/elements/advanced/sortable.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Sortable</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/sweet-alert.html" data-menu-path="/elements/advanced/sweet-alert.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Sweet alert</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/timeline.html" data-menu-path="/elements/advanced/timeline.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Timeline</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/toastr.html" data-menu-path="/elements/advanced/toastr.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Toastr</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/elements/advanced/treeview.html" data-menu-path="/elements/advanced/treeview.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/icons/fontawesome.html" data-menu-path="/icons/fontawesome.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Font Awesome</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/icons/feather.html" data-menu-path="/icons/feather.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/portlet/base.html" data-menu-path="/portlet/base.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Base</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/portlet/drag.html" data-menu-path="/portlet/drag.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Draggable</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/portlet/tab.html" data-menu-path="/portlet/tab.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Tab</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/portlet/tool.html" data-menu-path="/portlet/tool.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/widgets/general.html" data-menu-path="/widgets/general.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">General</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/widgets/chart.html" data-menu-path="/widgets/chart.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<!-- END Menu Section -->
					<div class="menu-item">
						<a href="/dashboard_assets/chart/apex-chart.html" data-menu-path="/chart/apex-chart.html" class="menu-item-link">
							<div class="menu-item-icon">
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								...
								<div class="menu-submenu">
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/basic/base.html" data-menu-path="/datatable/basic/base.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Base</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/basic/footer.html" data-menu-path="/datatable/basic/footer.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Footer</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/basic/scrollable.html" data-menu-path="/datatable/basic/scrollable.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Scrollable</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/basic/pagination.html" data-menu-path="/datatable/basic/pagination.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Pagination</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/basic/menu.html" data-menu-path="/datatable/basic/menu.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
							...
							<div class="menu-item">
								...
								<div class="menu-submenu">
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/advanced/column-rendering.html" data-menu-path="/datatable/advanced/column-rendering.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Column rendering</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/advanced/column-visibility.html" data-menu-path="/datatable/advanced/column-visibility.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Column visibility</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/advanced/footer-callback.html" data-menu-path="/datatable/advanced/footer-callback.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Footer callback</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/advanced/multiple-controls.html" data-menu-path="/datatable/advanced/multiple-controls.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Multiple controls</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/advanced/row-callback.html" data-menu-path="/datatable/advanced/row-callback.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
							...
							<div class="menu-item">
								...
								<div class="menu-submenu">
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/source/html.html" data-menu-path="/datatable/source/html.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">HTML</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/source/javascript.html" data-menu-path="/datatable/source/javascript.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
							...
							<div class="menu-item">
								...
								<div class="menu-submenu">
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/autofill.html" data-menu-path="/datatable/extension/autofill.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Auto fill</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/buttons.html" data-menu-path="/datatable/extension/buttons.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Buttons</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/column-reorder.html" data-menu-path="/datatable/extension/column-reorder.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Column reorder</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/fixed-header.html" data-menu-path="/datatable/extension/fixed-header.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Fixed header</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/fixed-column.html" data-menu-path="/datatable/extension/fixed-column.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Fixed column</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/key-table.html" data-menu-path="/datatable/extension/key-table.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Key table</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/row-group.html" data-menu-path="/datatable/extension/row-group.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Row group</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/row-reorder.html" data-menu-path="/datatable/extension/row-reorder.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Row reorder</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/scroller.html" data-menu-path="/datatable/extension/scroller.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Scroller</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/search-panes.html" data-menu-path="/datatable/extension/search-panes.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
											<span class="menu-item-text">Search panes</span>
										</a>
									</div>
									<div class="menu-item">
										<a href="/dashboard_assets/datatable/extension/select.html" data-menu-path="/datatable/extension/select.html" class="menu-item-link">
											<i class="menu-item-bullet"></i>
					...
					<!-- END Menu Section -->
					<div class="menu-item">
						<a href="/dashboard_assets/form/base.html" data-menu-path="/form/base.html" class="menu-item-link">
							<div class="menu-item-icon">
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/autosize.html" data-menu-path="/form/advanced/autosize.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Autosize</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/bs-maxlength.html" data-menu-path="/form/advanced/bs-maxlength.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Bootstrap maxlength</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/clipboard.html" data-menu-path="/form/advanced/clipboard.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Clipboard</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/datepicker.html" data-menu-path="/form/advanced/datepicker.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Date picker</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/datetimepicker.html" data-menu-path="/form/advanced/datetimepicker.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Date time picker</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/daterangepicker.html" data-menu-path="/form/advanced/daterangepicker.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Date range picker</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/inputmask.html" data-menu-path="/form/advanced/inputmask.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Input mask</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/select2.html" data-menu-path="/form/advanced/select2.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Select2</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/slider.html" data-menu-path="/form/advanced/slider.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Slider</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/touchspin.html" data-menu-path="/form/advanced/touchspin.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Touchspin</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/form/advanced/typeahead.html" data-menu-path="/form/advanced/typeahead.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/editor/basic.html" data-menu-path="/editor/basic.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Basic</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/editor/bubble.html" data-menu-path="/editor/bubble.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Bubble</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/editor/complex.html" data-menu-path="/editor/complex.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						<a href="/dashboard_assets/form/group.html" data-menu-path="/form/group.html" class="menu-item-link">
							<div class="menu-item-icon">
					...
					<div class="menu-item">
						<a href="/dashboard_assets/form/layout.html" data-menu-path="/form/layout.html" class="menu-item-link">
							<div class="menu-item-icon">
					...
					<div class="menu-item">
						<a href="/dashboard_assets/form/validation.html" data-menu-path="/form/validation.html" class="menu-item-link">
							<div class="menu-item-icon">
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/pages/login/login-1.html" data-menu-path="/pages/login/login-1.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Login 1</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/pages/login/login-2.html" data-menu-path="/pages/login/login-2.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/pages/register/register-1.html" data-menu-path="/pages/register/register-1.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Register 1</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/pages/register/register-2.html" data-menu-path="/pages/register/register-2.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="menu-item">
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="/dashboard_assets/pages/error/error-1.html" data-menu-path="/pages/error/error-1.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Error 1</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="/dashboard_assets/pages/error/error-2.html" data-menu-path="/pages/error/error-2.html" class="menu-item-link">
									<i class="menu-item-bullet"></i>
					...
					<div class="header-holder header-holder-desktop">
						<div class="header-container container-fluid g-4">
							<div class="header-wrap header-wrap-block justify-content-start">
								...
								<div class="dropdown d-inline">
									...
									<div class="dropdown-menu dropdown-menu-start dropdown-menu-animated">
										<a href="/dashboard_assets/#" class="dropdown-item">
											<div class="dropdown-icon">
												<i class="fa fa-boxes"></i>
											</div>
											<span class="dropdown-content">Inventory Manager</span>
											<div class="dropdown-addon">
												<span class="badge badge-warning rounded-pill">20</span>
											</div>
										</a>
								...
								<!-- BEGIN Dropdown -->
								<div class="dropdown d-inline">
									<button class="btn btn-flat-primary btn-wider ms-2" data-bs-toggle="dropdown">Features</button>
									<div class="dropdown-menu dropdown-menu-start dropdown-menu-wide dropdown-menu-animated overflow-hidden">
										<div class="dropdown-row">
											...
											<div class="dropdown-col d-flex flex-column align-items-start justify-content-center bg-primary text-white">
												...
												<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, commodi hic qui aspernatur doloremque quos tempora placeat culpa illum, voluptatibus delectus provident cumque aliquid enim, laborum aliquam. Quod, perferendis unde.</p>
												<a href="/dashboard_assets/pages/login/login-1.html" class="btn btn-light btn-wider">Login</a>
											</div>
											<!-- END Dropdown Column -->
											<!-- BEGIN Dropdown Column -->
											<div class="dropdown-col">
												...
												<div class="grid-nav grid-nav-action">
													<div class="grid-nav-row">
														<a href="/dashboard_assets/#" class="grid-nav-item">
											...
											<!-- END Dropdown Column -->
											<!-- BEGIN Dropdown Column -->
											<div class="dropdown-col border-start">
												<h4 class="dropdown-header">Tools</h4>
												<a href="/dashboard_assets/#" class="dropdown-item">
													<i class="dropdown-bullet"></i>
													<span class="dropdown-content">Components</span>
												</a>
												<a href="/dashboard_assets/#" class="dropdown-item">
													<i class="dropdown-bullet"></i>
													<span class="dropdown-content">Form Wizard</span>
												</a>
												<a href="/dashboard_assets/#" class="dropdown-item">
													<i class="dropdown-bullet"></i>
													<span class="dropdown-content">Documentation</span>
												</a>
												<a href="/dashboard_assets/#" class="dropdown-item">
													<i class="dropdown-bullet"></i>
													<span class="dropdown-content">Knowledge Base</span>
												</a>
												<a href="/dashboard_assets/#" class="dropdown-item">
													<i class="dropdown-bullet"></i>
													<span class="dropdown-content">Inventory Manager</span>
							...
							<div class="header-wrap hstack gap-2">
										...
										<div class="portlet border-0 portlet-scroll">
											...
											<div class="portlet-body p-0 rounded-0" data-toggle="simplebar">
												...
												<div class="rich-list rich-list-action">
													<a href="/dashboard_assets/#" class="rich-list-item">
												...
												<div class="rich-list-item w-100 p-0">
													<div class="rich-list-prepend">
														...
														<div class="avatar avatar-circle">
															<div class="avatar-display">
																<img src="/dashboard_assets/assets/images/avatar/" alt="Avatar image">
															</div>
														</div>
														<!-- END Avatar -->
													</div>
								...
								<!-- END Dropdown -->
								<button class="btn btn-flat-primary btn-icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-settings">
										...
										<div class="portlet border-0">
											<div class="portlet-header bg-primary rounded-0">
												...
												<div class="rich-list-item w-100 p-0">
													...
													<div class="rich-list-content">
														<h3 class="rich-list-title text-white thumbnail-fullname">Guest</h3>
														<span class="rich-list-subtitle text-white thumbnail-email">No email</span>
													</div>
													<div class="rich-list-append">
														<span class="badge badge-label-light fs-6">9+</span>
													</div>
					...
					<div class="header-container container-fluid g-4">
						...
						<div class="header-wrap">
							...
							<div class="btn-group me-2">
								<input type="radio" class="btn-check" name="timeOption" id="timeOption1" autocomplete="off" checked>
								<label class="btn btn-flat-primary" for="timeOption1">Today</label>
								<input type="radio" class="btn-check" name="timeOption" id="timeOption2" autocomplete="off">
								<label class="btn btn-flat-primary" for="timeOption2">Week</label>
								<input type="radio" class="btn-check" name="timeOption" id="timeOption3" autocomplete="off">
				...
				<div class="sticky-header" id="sticky-header-mobile">
					...
					<div class="header-holder header-holder-mobile">
						<div class="header-container container-fluid g-4">
							...
							<div class="header-wrap hstack gap-2">
								<button class="btn btn-flat-primary btn-icon" data-bg-toggle="offcanvas" data-bg-target="#offcanvas-todo">
									<i class="far fa-calendar-alt"></i>
								</button>
								<!-- BEGIN Dropdown -->
								<div class="dropdown">
									...
									<div class="portlet">
										<div class="portlet-header">
											...
											<div class="portlet-addon">
												<!-- BEGIN Dropdown -->
												<div class="dropdown">
													<button class="btn btn-label-primary btn-icon" data-bs-toggle="dropdown">
														<i class="fa fa-ellipsis-h"></i>
													</button>
												...
												<div class="carousel-item">
													...
													<div class="rich-list">
														<div class="rich-list-item">
															...
															<div class="rich-list-append">
																<span class="badge badge-label-success fs-6">+$17</span>
															</div>
														</div>
														<div class="rich-list-item">
															<div class="rich-list-prepend">
															...
															<div class="rich-list-append">
																<span class="badge badge-label-danger fs-6">-$127</span>
															</div>
														</div>
														<div class="rich-list-item">
															<div class="rich-list-prepend">
															...
															<div class="rich-list-append">
																<span class="badge badge-label-success fs-6">+$56</span>
															</div>
														</div>
														<div class="rich-list-item">
															<div class="rich-list-prepend">
															...
															<div class="rich-list-append">
																<span class="badge badge-label-success fs-6">+$6</span>
															</div>
														</div>
														<div class="rich-list-item">
															<div class="rich-list-prepend">
															...
															<div class="rich-list-append">
																<span class="badge badge-label-danger fs-6">-$25</span>
															</div>
														</div>
													</div>
													<!-- END Rich List -->
									...
									<div class="portlet portlet-primary">
										<div class="portlet-header">
											...
											<div class="portlet-addon">
												<!-- BEGIN Dropdown -->
												<div class="dropdown">
													<button class="btn btn-label-light dropdown-toggle" data-bs-toggle="dropdown">June, 2020</button>
													<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
														<a class="dropdown-item" href="#">
															<div class="dropdown-icon">
																<i class="fa fa-poll"></i>
									...
									<div class="row portlet-row-fill-sm">
										<div class="col-sm-6">
											...
											<div class="portlet">
												<div class="portlet-header">
													...
													<div class="portet-addon">
														<!-- BEGIN Dropdown -->
														<div class="dropdown">
															<button class="btn btn-text-secondary btn-icon" data-bs-toggle="dropdown">
																<i class="fa fa-ellipsis-h"></i>
															</button>
															<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
																<a class="dropdown-item" href="#">
												...
												<div class="portlet-footer">
													<span class="text-muted">Completed: <strong>8</strong></span>
												</div>
											</div>
											<!-- END Portlet -->
											<!-- BEGIN Portlet -->
											<div class="portlet">
												<div class="portlet-body">
													<!-- BEGIN Widget -->
													<div class="widget8">
														<div class="widget8-addon" data-bs-toggle="tooltip" data-bs-placement="right" title="New users for last month">
										...
										<div class="col-sm-6">
											...
											<div class="portlet">
												...
												<div class="portlet-footer">
													<span class="text-muted">Fixed: <strong>4</strong></span>
												</div>
											</div>
											<!-- END Portlet -->
											<!-- BEGIN Portlet -->
							...
							<div class="portlet">
								<div class="portlet-header">
									...
									<div class="portlet-addon">
										<!-- BEGIN Dropdown -->
										<div class="dropdown">
											<button class="btn btn-label-primary dropdown-toggle" data-bs-toggle="dropdown">Export</button>
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
												<a class="dropdown-item" href="#">
													<div class="dropdown-icon">
														<i class="fa fa-poll"></i>
										...
										<div class="portlet-body">
											...
											<div class="timeline timeline-timed">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content">
														<p class="mb-0">Received a new feedback on <a href="/dashboard_assets/#">GoFinance</a> App product.</p>
													</div>
												</div>
												<div class="timeline-item">
												...
												<div class="timeline-item">
													...
													<div class="timeline-content">
														<p class="mb-0">Make Deposit <a href="/dashboard_assets/#">USD 700</a> o ESL.</p>
													</div>
												</div>
											</div>
											<!-- END Timeline -->
									...
									<div class="portlet">
										<div class="portlet-header">
											...
											<div class="portlet-addon">
												<!-- BEGIN Dropdown -->
												<div class="dropdown">
													<button class="btn btn-label-primary dropdown-toggle" data-bs-toggle="dropdown">All</button>
													<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
														<a class="dropdown-item" href="#">
													...
													<div class="widget4">
														<div class="widget4-group">
															<div class="widget4-display">
																...
																<h2 class="widget4-highlight">54,234</h2>
															</div>
														</div>
													</div>
													<!-- END Widget -->
													...
													<div class="widget4">
														<div class="widget4-group">
															<div class="widget4-display">
																...
																<h2 class="widget4-highlight">$67,50</h2>
															</div>
														</div>
													</div>
													<!-- END Widget -->
													...
													<div class="widget4">
														<div class="widget4-group">
															<div class="widget4-display">
																...
																<h2 class="widget4-highlight">242</h2>
															</div>
														</div>
													</div>
													<!-- END Widget -->
										...
										<div class="portlet-body">
											...
											<div class="rich-list rich-list-flush">
												<div class="rich-list-item flex-column align-items-stretch">
													...
													<!-- END Rich List -->
													<p class="text-justify mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem optio libero deleniti minus culpa modi, quam rem eius quaerat aut.</p>
												</div>
												<div class="rich-list-item flex-column align-items-stretch">
													<!-- BEGIN Rich List -->
													<div class="rich-list-item p-0 mb-2">
														...
														<div class="rich-list-content">
															...
															<span class="rich-list-subtitle">Senior Developer</span>
														</div>
														<div class="rich-list-append">
															<button class="btn btn-label-primary">Follow</button>
														</div>
													...
													<!-- END Rich List -->
													<p class="text-justify mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus non, in, culpa libero quidem consequatur.</p>
												</div>
												<div class="rich-list-item flex-column align-items-stretch">
													<!-- BEGIN Rich List -->
													<div class="rich-list-item p-0 mb-2">
													...
													<!-- END Rich List -->
													<p class="text-justify mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae nesciunt blanditiis tempora eius accusamus, libero facere amet! Neque quis odio dicta dolor, eaque consectetur. Nihil?</p>
												</div>
												<div class="rich-list-item flex-column align-items-stretch">
													<!-- BEGIN Rich List -->
													<div class="rich-list-item p-0 mb-2">
													...
													<!-- END Rich List -->
													<p class="text-justify mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita praesentium rem aut aliquam perferendis harum molestiae cum beatae, perspiciatis, at nisi reprehenderit minus voluptatibus veritatis. Iste laborum possimus nobis vero?</p>
												</div>
											</div>
											<!-- END Rich List -->
										</div>
				...
				<div class="container-fluid g-4">
					<div class="row g-3">
						<div class="col-sm-6 text-center text-sm-start">
							<p class="mb-0"><i class="far fa-copyright"></i> <span id="copyright-year"></span> Upmin. All rights reserved</p>
						</div>
			...
			<div class="portlet">
				...
				<div class="portlet-body">
					...
					<div class="d-grid gap-1">
						...
						<!-- BEGIN Form Switch -->
						<div class="form-check form-check-lg form-switch">
							<input type="checkbox" class="form-check-input" id="offcanvas-setting-2" checked="checked">
			...
			<div class="portlet">
				...
				<div class="portlet-body">
					...
					<div class="d-grid gap-1">
						...
						<!-- BEGIN Form Switch -->
						<div class="form-check form-check-lg form-switch">
							<input type="checkbox" class="form-check-input" id="offcanvas-setting-5" checked="checked">
			...
			<div class="portlet">
				...
				<div class="portlet-body">
					...
					<div class="d-grid gap-1">
						...
						<!-- BEGIN Form Switch -->
						<div class="form-check form-check-lg form-switch">
							<input type="checkbox" class="form-check-input" id="offcanvas-setting-8" checked="checked">
